...
/*   Updated: 2022/03/20 18:24:12 by plouvel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	init_ncurses(void)
{
	...
	init_pair(PAIR_STEP_3, COLOR_GREEN, COLOR_BLACK);
	init_pair(PAIR_STEP_4, COLOR_CYAN, COLOR_BLACK);
	init_pair(PAIR_STEP_5, COLOR_MAGENTA, COLOR_BLACK);
	init_pair(PAIR_STEP_6, COLOR_RED, COLOR_BLACK);
	noecho();
	curs_set(0);
	nonl();
	cbreak();
